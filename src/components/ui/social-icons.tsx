...
/**
 * Glyphs de marca (Instagram, Facebook) como SVG inline, no mesmo padrão do
 * WhatsAppIcon (src/components/ui/whatsapp-icon.tsx) — nenhuma biblioteca já
 * instalada (lucide-react) tem esses ícones de marca.
 */
