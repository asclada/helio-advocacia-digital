...
- **Phase 2 — Base UI components:** in progress. Done so far: test setup (Vitest + Testing Library + jest-axe), `Container`/`Section` layout wrapper, `Button` (primary/secondary/ghost variants). Remaining: `Badge`, `Card`, `Input` + `Label`.
